...
BPLPOINTERS:
	...
	dc.w	$0180,$003	; color0 - SFONDO
	dc.w	$0182,$FFF	; color1 - SCRITTE

WAITS:
	DC.W	$8001,$FF00	; horizontal position masked off
	DC.W	$0108,$0008	; BPL1MOD
	DC.W	$0180,$0224	; BG COLOR
	DC.W	$0182,$0AAA	; BG COLOR

	DC.W	$A001,$FF00	; horizontal position masked off
	DC.W	$0108,$0000	; BPL1MOD
	DC.W	$0180,$0003	; BG COLOR
	DC.W	$0182,$0FFF	; BG COLOR
