...
VBint:					;Blank template VERTB interrupt
	...
	move.w	d0,$9c(a6)
	;move.w	d0,$9c(a6)		; PERKE' 2 VOLTE??
.notvb:	
	movem.l	(sp)+,d0/a6		;restore
	rte

PRINT2X:				; Routine che stampa
	MOVEM.L	D1/A2,-(SP)	; SAVE TO STACK
	MOVE.L	#KONEY2X,A2
	MOVEQ	#0,D1		; RESET D6
	MOVE.B	#10-1,D1			
...
.LOOP:				; LOOP KE CICLA LA BITMAP
	ADD.W	#14,A1		; POSITIONING

	MOVE.W	(A2)+,(A1)	; QUESTA ISTRUZIONE FA ESPLODERE TUTTO
	ADD.W	(A3,D3.W),A1	; POSITIONING WITH DISPLACEMENT
	ADD.W	#2,D3		; INCREMENTO INDICE TAB
	AND.W	#256-1,D3		; AND TIRA FUORI SEMPRE FINO A X E POI WRAPPA
	MOVE.W	(A2)+,(A1)	; QUESTA ISTRUZIONE FA ESPLODERE TUTTO

	ADD.W	#2,A1		; POSITIONING WITH DISPLACEMENT
	...
	DBRA	D1,.LOOP
	MOVEM.L	(SP)+,D1/A2	; FETCH FROM STACK
	RTS
...
DISPLACETABLE:
	DC.W 2,2,2,2,2,2,2,2,2,2,2,2,2,2,3,1
	DC.W 2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2
	DC.W 2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2
	DC.W 2,3,2,1,2,2,2,2,2,2,2,2,2,2,2,2
	DC.W 2,2,2,2,2,2,2,2,2,2,2,3,2,2,2,2
	DC.W 2,2,2,2,2,2,2,2,2,2,2,1,2,2,2,2
	DC.W 2,3,2,2,2,2,2,2,2,1,2,2,2,2,2,2
	DC.W 2,2,2,3,2,2,2,3,2,2,2,2,2,2,2,2
