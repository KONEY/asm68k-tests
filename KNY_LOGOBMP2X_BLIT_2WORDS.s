...
BLITINPLACE:
	...
	MOVE.W	#(w-32)/8,BLTDMOD; BLTDMOD 40-4=36 il rettangolo
	...
	move.l	#KONEY1X,BLTAPTH	; BLTAPT  (fisso alla figura sorgente)

	move.w	#(32*2*5)+2,BLTSIZE; BLTSIZE (via al blitter !)
