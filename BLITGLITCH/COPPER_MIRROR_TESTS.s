...
Demo:			;a4=VBR, a6=Custom Registers Base addr
	...
	MOVE.L	#$00100090,D2		; START | END COLOR
	...
	MOVE.L	#$00900010,D2		; START | END COLOR
	MOVE.W	#4,D3			; STEP IN PIXELS
	;BSR.W	__COPPER_CREATE_GRADIENT
	;
	;MOVE.W	#$2C,D0			; PRELOAD H STARTPOS
	...
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bypl,A4
	BSR.W	__FILL_MIRROR_TEXTURE
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bypl*2,A4
	BSR.W	__FILL_MIRROR_TEXTURE

	LEA	X_TEXTURE_MIRROR,A3		; FILLS A PLANE
	LEA	X_TEXTURE_MIRROR,A4		; FILLS A PLANE
	BSR.W	__MIRROR_PLANE
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bypl,A3 ; FILLS A PLANE
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bypl,A4 ; FILLS A PLANE
	BSR.W	__MIRROR_PLANE
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bypl*2,A3 ; FILLS A PLANE
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bypl*2,A4 ; FILLS A PLANE
	BSR.W	__MIRROR_PLANE
...
__BLIT_GLITCH_BAND:
	MOVE.L	(A5),D0			; A5 PRELOADED WITH RESET ADDRESS
	MOVE.L	4(A5),A3			; NEXT LONG CONTAINS ACTUALE POINTER
	SUB.L	#(TEXTURE_H-64)*bypl,D0	; OFFSET FOR TEXTURE END
	CMP.L	D0,A3
	BHI.S	.notEnd
	MOVE.L	(A5),A3			; RELOAD RESET ADDRESS
	.notEnd:
...
__SCROLL_X_1_4_BIS:
	...
	.skip2:
	;bsr	WaitBlitter		; BLITTER SHOULD BE FAST ENOUGH
	MOVE.W	D7,(A4)			; PATCH LOST WORD
	; ## MAIN BLIT ####
	RTS
...
__SCROLL_Y_HALF:
	...
	MOVE.L	#$7FFFFFFE,BLTAFWM		; THEY'LL NEVER
	MOVE.W	#%0000100111110000,BLTCON0
	MOVE.W	#%0000000000000000,BLTCON1	; BLTCON1
...
__SCROLL_COMBINED:
	...
	MOVE.L	A4,A2
	MOVEQ	#10-1,D0
	MOVE.W	#bypl-Y_SLICE/16*2,BLIT_A_MOD
	MOVE.W	#bypl-Y_SLICE/16*2,BLIT_D_MOD
	MOVE.W	X_EASYING,X_1_4_SHIFT
	SUB.W	#2,X_1_4_SHIFT
	.loop:
	MOVE.W	#((he/2+16*bpls)*3)*64+(Y_SLICE/16),BLIT_SIZE
	BSR.W	__SCROLL_Y_HALF
	SUB.L	D1,A3			; D1 COMES FROM SUBROUTINE
	SUB.W	#1,Y_HALF_SHIFT
	TST.W	Y_HALF_SHIFT
	BNE.S	.skip
	MOVE.W	#1,Y_HALF_SHIFT
	.skip:
	;## NEW H BLIT ######
	;MOVEM.L	A3-A4,-(SP)		; SAVE TO STACK
	;MOVE.L	A1,A3
	;MOVE.L	A2,A4
	;MOVE.W	#(X_SLICE)*64+(wi/2/16),BLIT_SIZE
	;ADD.W	#1,X_1_4_SHIFT
	...
	;ADD.W	D3,A2
	;SWAP	D3
	;MOVEM.L	(SP)+,A3-A4		; FETCH FROM STACK
	;## NEW H BLIT ######
	ADD.W	D3,A3
	ADD.W	D3,A4
	DBRA	D0,.loop
...
__BLOCK_0000:
	...
	;#################################
	MOVE.W	#(he/2+16)*bpls*64+wi/16,BLIT_SIZE
	MOVE.L	#0,BLIT_A_MOD
	MOVE.B	#1,Y_HALF_DIR
	;MOVE.W	#2,Y_HALF_SHIFT
	LEA	BGPLANE0,A3
...
TEXTURERESET7:	DC.L X_TEXTURE_MIRROR+TEXTURE_H*bypl*3
		DC.L X_TEXTURE_MIRROR+TEXTURE_H*bypl*3
...
COPPER:
	...
	.Palette:
	DC.W $0180,$0030,$0182,$0F00,$0184,$0065,$0186,$00AB
	DC.W $0188,$0F0F,$018A,$0636,$018C,$0077,$018E,$0FF0
