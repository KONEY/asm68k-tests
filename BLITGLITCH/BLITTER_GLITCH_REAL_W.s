...
TIMELINE:		DC.L __BLOCK_OK
		DC.L __BLOCK_TOP,__BLOCK_0	; 1 1: Solo Robot
		DC.L __BLOCK_END
...
BGPLANE0:		DC.L BG1+(bpl*h*0)
BGPLANE1:		DC.L BG1+(bpl*h*1)
BGPLANE2:		DC.L BG1+(bpl*h*2)
BGPLANE3:		DC.L BG1+(bpl*h*3)
BGPLANE4:	DC.L BG1+(bpl*h*4)
DITHERPLANE:	DC.L BUFFERDITHER+(bpl*h*1)
SCROLL_INDEX:	DC.W 0
SCROLL_DEST:	DC.L 0
SCROLL_SRC:	DC.L 0
SPR_0_POS:	DC.B $7C		; K
...
PATTERN1:		
	...
	DC.L %11111111011111111111111011111111
	DC.L %11111111011111111111111011111111
	DC.L %11111111011111111111111011111111
	DC.L %11111111011111111111111011111111
	DC.L %01111111111111111111111111111110
...
;BUFFERTOP:	DS.B h*bpl
BG1:		DS.B h*bwid	; two buffers
;BUFFERBOT:	DS.B h*bpl/2
