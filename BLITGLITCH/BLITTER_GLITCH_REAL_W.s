...
__BLIT_GLITCH_SLICE:
	...
	MOVE.W	#0,BLTAMOD	; BLTAMOD =0 perche` il rettangolo
	MOVE.W	#bpl-(16/16*2),BLTDMOD	; BLTDMOD 40-4=36 il rettangolo
...
__BLIT_GLITCH_BAND:
	...
	MOVE.W	D1,BLTCON0		; BLTCON0 (usa A+D); con shift di un pixel
	MOVE.W	#%0000000000000000,BLTCON1	; BLTCON1 BIT 12 DESC MODE
	MOVE.W	BLIT_A_MOD,BLTAMOD	; BLTAMOD =0 perche` il rettangolo
	MOVE.W	BLIT_D_MOD,BLTDMOD	; BLTDMOD 40-4=36 il rettangolo
...
__SCROLL_X_1_4:
	...
	MOVE.W	D1,BLTCON0		; BLTCON0 (usa A+D); con shift di un pixel
	MOVE.W	#%0000000000000000,BLTCON1	; BLTCON1 BIT 12 DESC MODE
	MOVE.W	#bpl/2-4,BLTAMOD		; BLTAMOD =0 perche` il rettangolo
	MOVE.W	#bpl/2-4,BLTDMOD		; BLTDMOD 40-4=36 il rettangolo

	CMP.B	#1,D5
	BEQ.B	.goBlitter			; FOR LEFT
	ADD.L	#bpl*h/2-(bpl/2)-1+4,A3
	ADD.L	#bpl*h/2-(bpl/2)-1+4,A4
	MOVE.W	#%0000000000000010,BLTCON1	; BLTCON1 BIT 12 DESC MODE
...
TIMELINE:		DC.L __BLOCK_TEST_Y,__BLOCK_0,__BLOCK_TEST_X,__BLOCK_0
		DC.L __BLOCK_END
