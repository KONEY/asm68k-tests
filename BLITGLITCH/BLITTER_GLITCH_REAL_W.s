...
__SHIFTTEXT:
	...
	MOVE.W	#(hband-1)*64+w/16,BLTSIZE	; BLTSIZE

	MOVEM.L	(SP)+,D0-A6		; FETCH FROM STACK
	RTS

__BLIT_GLITCH_SLICE:
	MOVE.W	#%1000100111110000,D1
	...
	CMP.L	#_MODULE-(bpl*h/2),A3	; LAST WORD OF DATA?
	BLS.S	.notEnd
	MOVE.L	GLITCHRESET,GLITCHGOOD	; RESET
	MOVE.L	GLITCHGOOD,A3		; RELOAD
	.notEnd:	

	ROR.W	#4,D1
	bsr	WaitBlitter
	MOVE.W	BLIT_X_MASK,BLTAFWM	; BLTAFWM
	MOVE.W	BLIT_X_MASK,BLTALWM	; BLTALWM
...
__BLIT_GLITCH_TILE:
	...
	;MOVE.W	$DFF006,$DFF180		; show rastertime left down to $12c
	BRA.S	.waitData			; AND CHECK AGAIN
	.dataOk:
	CMP.L	#_MODULE-(bpl/2),A3	; LAST WORD OF DATA?
	BLS.S	.notEnd
	MOVE.L	GLITCHRESET,GLITCHGOOD	; RESET
	MOVE.L	GLITCHGOOD,A3		; RELOAD
	.notEnd:	
...
__SCROLL_X_PROGR_SPLIT:
	...
	ADD.L	#bpl*X_SPLIT_SLICE,SCROLL_SRC_T
	ADD.L	#bpl*X_SPLIT_SLICE,SCROLL_DEST_T
	ADD.B	D6,D3			; CAN BE 1 OR -1
...
__SCROLL_X_PROGR_SPLITX2:
	...
	ADD.L	#bpl*X_SPLIT2X_SLICE,SCROLL_SRC_T
	ADD.L	#bpl*X_SPLIT2X_SLICE,SCROLL_DEST_T
	ADD.B	D6,D3			; CAN BE 1 OR -1
...
__SCROLL_X_Y_1_4:
	...
	ROR.W	#4,D1
	bsr	WaitBlitter
	MOVE.W	#bpl/2-2,BLTAMOD		; D7 HERE FOR CRAZY FX!!
	MOVE.W	#bpl/2-2,BLTDMOD		; BLTDMOD
	;MOVE.W	BLIT_A_MOD,BLTAMOD	; BLTAMOD
	;MOVE.W	BLIT_D_MOD,BLTDMOD	; BLTDMOD
	MOVE.W	D1,BLTCON0		; BLTCON0
	MOVE.W	#%0000000000000000,BLTCON1	; BLTCON1
	...
	ADD.L	#bpl*h/2-(bpl/2)+2-1,A3
	ADD.L	#bpl*h/2-(bpl/2)+2-1,A4
	;ADD.L	#bpl*h-1,A3
	;ADD.L	#bpl*h-1,A4
	MOVE.W	#%0000000000000010,BLTCON1	; BLTCON1 BIT 12 DESC MODE
...
__Y_SHIFT_LFO:
	...
	ADD.B	#1,D0			; FIX FOR -1 VALUES
	MOVE.B	D0,Y_1_4_SHIFT
	RTS

__BLOCK_1_4_TEST:
	MOVE.B	#8,X_SHIFT_LFO_MAX
	MOVE.B	#7,Y_SHIFT_LFO_MAX
	;MOVE.B	#1,X_1_4_SHIFT
	;MOVE.B	#3,Y_1_4_SHIFT		; VSHIFT
...
TIMELINE:		DC.L __BLOCK_PLASMA,__BLOCK_1_4_TEST,__BLOCK_TEST_Y,__BLOCK_0,__BLOCK_TEST_X,__BLOCK_0
		DC.L __BLOCK_END
...
GLITCHRESET:	DC.L MODULE+bpl*h*7
...
COPPER:
	...
	;DC.W $0180,$0333,$0182,$0222,$0184,$0333,$0186,$0444
