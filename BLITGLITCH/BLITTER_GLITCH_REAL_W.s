...
__BLIT_GLITCH_TILE:
	...
	MOVE.W	#%00001111111000000,D1	; for texture?
	; ## MAIN BLIT ####
	...
	MOVE.W	#bpl-(32/16*2),BLTAMOD		; BLTAMOD =0 perche` il rettangolo
	MOVE.W	#0,BLTBMOD		; BLTBMOD =0 for texture
	MOVE.W	#bpl-(32/16*2),BLTDMOD	; BLTDMOD 40-4=36 il rettangolo

	MOVE.L	A3,BLTAPTH		; BLTAPT  (fisso alla figura sorgente)
	MOVE.L	#PATTERN1,BLTBPTH		; TEXTURE
	MOVE.L	A4,BLTDPTH
...
COPPER:
	...
	.Palette:
	DC.W $0180,$0000,$0182,$0222,$0184,$0333,$0186,$0444
